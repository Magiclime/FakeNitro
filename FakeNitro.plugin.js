        ...
        const plugin = (Plugin, Api) => {
          ...
          return class FakeNitro extends Plugin {
              ...
              return Settings.SettingPanel.build(
                ...
                ...[
                  new Settings.SettingGroup('Features').append(
                    ...[
                      new Settings.Switch(
                        ...
                        'Enable or disable 1080p/source @ 60fps screensharing. This adapts to your current nitro status.',
                  ...
                  new Settings.SettingGroup('Emojis').append(
                    new Settings.Switch(
                      'Nitro Emotes Bypass',
                      'Enable or disable using the Nitro Emote bypass.',
                      this.settings.emojiBypass,
                      (value) => (this.settings.emojiBypass = value)
                    ),
                    new Settings.Slider(
                      'Size',
                      'The size of the emoji in pixels. 40 is recommended.',
                      16,
                      64,
                  ...
                  new Settings.SettingGroup('Profile Picture').append(
                    ...[
                      new Settings.Switch(
                        'Clientsided Profile Picture',
                        'Enable or disable clientsided profile pictures.',
                        this.settings.clientsidePfp,
                        (value) => (this.settings.clientsidePfp = value)
                      ),
                      new Settings.Textbox(
                        'URL',
                        'The direct URL that has the profile picture you want.',
                        this.settings.pfpUrl,
                        (image) => {
                          try {
                            new URL(image);
                          } catch {
            ...
            saveAndUpdate() {
              ...
              if (!this.settings.screenSharing) {
                switch (this.originalNitroStatus) {
                  case 1:
                    BdApi.injectCSS(
                      'screenShare',
                      `#app-mount > div.layerContainer-yqaFcK > div.layer-2KE1M9 > div > div > form > div:nth-child(2) > div > div > div.flex-1xMQg5.flex-1O1GKY.horizontal-1ae9ci.horizontal-2EEEnY.flex-1O1GKY.directionRow-3v3tfG.justifyStart-2NDFzi.alignStretch-DpGPf3.noWrap-3jynv6.modalContent-BM7Qeh > div:nth-child(1) > div > button:nth-child(4) {
                                    display: none;
                                  }`
                    );
                  ...
                  default:
                    ...
                    this.screenShareFix = setInterval(() => {
                      document
                        .querySelector(
                          '#app-mount > div.layerContainer-yqaFcK > div.layer-2KE1M9 > div > div > form > div:nth-child(2) > div > div > div.flex-1xMQg5.flex-1O1GKY.horizontal-1ae9ci.horizontal-2EEEnY.flex-1O1GKY.directionRow-3v3tfG.justifyStart-2NDFzi.alignStretch-DpGPf3.noWrap-3jynv6.modalContent-BM7Qeh > div:nth-child(1) > div > button:nth-child(2)'
                        )
                        .click();
                      document
                        .querySelector(
                          '#app-mount > div.layerContainer-yqaFcK > div.layer-2KE1M9 > div > div > form > div:nth-child(2) > div > div > div.flex-1xMQg5.flex-1O1GKY.horizontal-1ae9ci.horizontal-2EEEnY.flex-1O1GKY.directionRow-3v3tfG.justifyStart-2NDFzi.alignStretch-DpGPf3.noWrap-3jynv6.modalContent-BM7Qeh > div:nth-child(2) > div > button:nth-child(2)'
                        )
                        .click();
                      clearInterval(this.screenShareFix);
                    }, 100);
              ...
              if (this.settings.clientsidePfp && this.settings.pfpUrl) {
                this.clientsidePfp = setInterval(() => {
                  document
                    .querySelectorAll(
                      `[src="${DiscordAPI.currentUser.discordObject.avatarURL.replace(
                        '.png',
                        '.webp'
                      )}"]`
                    )
                  ...
                  document
                    .querySelectorAll(
                      `[src="${DiscordAPI.currentUser.discordObject.avatarURL}"]`
                    )
                    .forEach((avatar) => {
                      avatar.src = this.settings.pfpUrl;
                    });
                  document
                    .querySelectorAll(
                      `.avatarContainer-28iYmV.avatar-3tNQiO.avatarSmall-1PJoGO`
                    )
                    .forEach((avatar) => {
                      if (
                        !avatar.style.backgroundImage.includes(
                          DiscordAPI.currentUser.discordObject.avatarURL
                        )
                      )
                        return;
            ...
            removeClientsidePfp() {
              ...
              document
                .querySelectorAll(`[src="${this.settings.pfpUrl}"]`)
                .forEach((avatar) => {
              ...
              document
                ...
                .forEach((avatar) => {
                  if (
                    !avatar.style.backgroundImage.includes(this.settings.pfpUrl)
                  )
                    return;
            ...
            onStart() {
              this.originalNitroStatus =
                DiscordAPI.currentUser.discordObject.premiumType;
              this.saveAndUpdate();
